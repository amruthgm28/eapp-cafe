...
function Navbar() {
  ...
  return (
    ...
    ${
      sticky
        ? "sticky-navber shadow-md bg-base-200 duration-300 transition-all ease-in-out"
        : ""
    }  `}
    >
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-end space-x-3">
          ...
          </label>
          {
           ...
           <div className="">
            <a
              className="bg-black text-white rounded-lg py-2 px-3 hover:bg-slate-800 duration-300 cursor-pointer"
